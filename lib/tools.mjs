// lib/tools.mjs — 27 个工具的注册（15 个 import_* + import_agents + doctor +
// export_claude/codex/kimi + export_bundle/restore_bundle + sync_to_claude +
// list_imported_sessions + retract_import + scan_discover + verify_session）
//
...
export function registerTools(ctx, registryDir) {
  ...
  // doctor 为第 27 个工具：迁移后健康检查（REQ-66）。
