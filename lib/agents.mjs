...
/**
 * REQ-59/61 入口：收集 pi/opencode/Claude 候选 → 规划 → （preview 时）只返回 plan /
 * （apply 时）落盘。
 * @param {object} ctx host ctx（fs 服务）
 * @param {object} args { piRoot?, opencodeRoot?, claudeRoot?, claudeProjectRoot?, agentsHome?, apply?, preview? }
