...
export function convertClaudeJsonl(raw, args = {}) {
  ...
  const syn = synthesizeSession({ meta, turns: seedTurns, title: explicitTitle ? finalTitle : undefined, provider: 'claude-code', model, skipped, records: recs.length, imported: { sourcePath: args.sourcePath } })
