...
export function convertReasonixJsonl(raw, args = {}) {
  ...
  const out = synthesizeSession({ meta, turns: seedTurns, title: explicitTitle ? finalTitle : undefined, provider: 'reasonix', model: 'reasonix', skipped, records: recs.length, imported: { sourcePath: args.sourcePath } })
